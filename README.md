...
- [x] 【调通SQLCoder-7B】把SQLCoder-7B调通, https://cloud.baidu.com/doc/WENXINWORKSHOP/s/Hlo472sa2
  ...
  - [x] 最后收费+500, 不过和这个北大客户哥天涯相忘了, 接下来全身心专注搞搞自己的其他事业
## 【硬件】项目
### 【华师】修电脑
- [x] 【电脑义诊】 充当电脑硬件购机咨询, 认识个义务伙计
### 【英特尔】玩硬件
...
- [x] 【cmrc自动化测试系统 **日志**模块】
  ...
  - [x] 【难点】硬件上的调试有点恶心, 问题:
    ...
    - [ ] 【展望】如何改造成【去中心化】的实现?
  - [ ] 【重构】多线程 改成 多进程, 测试收集log的时间变化与否 
- [ ] 【项目部署导出exe **部署**模块】
  - [x] 【虚拟环境】导出test.exe和run.exe可以运行|pyinstaller要安装在虚拟环境中, 可以在spec中加入pathex参数
  - [ ] github的action的操作  
  - [ ] 创建虚拟环境以及那些依赖【有点先帝创业未半而中道崩殂的意味】
## 【实践】项目
- [x] 【Python教学中心面试】3/3, 去浦东的贝乐教学去讲Python|格子了, 距离太远, 感觉不划算!【**鸽子**】
- [x] 【AI应用软件出海】拥有**全栈开发**能力, 然后AI应用软件出海, 付费服务【**不了了之**】
...
- [x] 【视频剪辑】香海归来之后, 帮姐姐剪辑视频【**不可行**】
  - [x] 我判断了一下, 首先要从腾讯视频号把视频扣下来, 这一点需要copyright不可行
  - [x] 把视频download下来之后，剪辑是很简单的 
- [x] 【手机购物指导】操场认识的karl爷爷, 指导他京东购物【**不被信任**】
  - [x] 首先教会他如何根据手机号搜索+vx, 不过我的微信设置不能手机号搜索
  - [x] 他不信任我, 不了了之了, 教训: **提高对陌生人的帮助阈值** 
### 农村留守老人的电视娱乐
- [x] 【电视维修】帮我老家的爷爷奶奶修好电视【**童年和孝**】
  - [x] 春天找人修修吧
  - [x] 我爸爸已经处理好了
### 张警察 相关合作
- [ ] 【IP溯源】追寻找到【开范了儿】这个公众号的运维在哪里, 最好是谁
## 【媒体】项目
### 【抖音号】运营
